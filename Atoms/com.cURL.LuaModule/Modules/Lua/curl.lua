...
local lib_path = get_script_path() .. "curl.so"
local curl = ffi.load(lib_path)
...
ffi.cdef[[
    ...
    // Options (subset of common ones, full list is huge)
    // Note: In FFI, we can use the integer values directly, but enums are nicer.
    // We will define the most common ones here.
    typedef enum {
